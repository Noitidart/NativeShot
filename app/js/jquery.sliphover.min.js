//// Noitidart edit - I modified this so it uses jsonToDOM
/**
 * sliphover v2.0.5 - https://github.com/wayou/SlipHover/blob/91d995e8795855ec977510ba11cdf50b60deec34/src/jquery.sliphover.js
 * require jquery 1.7+
 * MIT License
    ...
    SlipHover.prototype = {
        ...
        createOverlay: function(instance, direction, $element) {
            ...
            if (instance.settings.verticalMiddle) {
				...
				content[0].appendChild(jsonToDOM(gHoverEl[$element.attr(instance.settings.caption)], document, {}));
            } else {
                content = $(jsonToDOM(gHoverEl[$element.attr(instance.settings.caption)], document, {}));
            }
			...
			// $overlay[0].appendChild(content[0]);
            return $overlay;
        },
