		...
		r.onloadend = function() {
			...
			promise_saveToDisk.then(
				function(aVal) {
					...
					myServices.as.showAlertNotification(core.addon.path.images + 'icon48.png', core.addon.name + ' - ' + 'File Path Copied', 'Screenshot was successfully saved and file path was copied to clipboard', false, null);
				...
				function(aReason) {
					...
					myServices.as.showAlertNotification(core.addon.path.images + 'icon48.png', core.addon.name + ' - ' + 'Error', 'Screenshot failed to save to disk, see browser console for more details', false, null);
					//deferred_createProfile.reject(rejObj);
				}
			).catch(
				function(aCaught) {
					...
					myServices.as.showAlertNotification(core.addon.path.images + 'icon48.png', core.addon.name + ' - ' + 'CATCH', 'developer error stupid', false, null);
					//deferred_createProfile.reject(rejObj);
				}
			);
		};
